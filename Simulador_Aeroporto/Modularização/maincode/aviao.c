...
void *rotina_aviao(void *arg) {
    ...
    log_message("AVIAO [%03d]: Pouso em andamento (2 segundos).\n", aviao->ID);
    sleep(2);
    liberar_pouso(aviao);
    ...
    log_message("AVIAO [%03d]: Desembarque de passageiros em andamento (3 segundos).\n", aviao->ID);
    sleep(3);
    ...
    log_message("AVIAO [%03d]: Decolagem em andamento (2 segundos).\n", aviao->ID);
    sleep(2);
